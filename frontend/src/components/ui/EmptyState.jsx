...
export const EmptyState = ({ 
  ...
  <div className={cn("flex flex-col items-center justify-center p-12 text-center space-y-4 bg-gray-50/50 rounded-3xl border-2 border-dashed border-gray-100", className)}>
